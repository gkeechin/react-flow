...
const initialElements = [
  { id: 'interaction-1', type: 'input', data: { label: 'Node 1' }, position: { x: 250, y: 5 } },
  { id: 'interaction-2', data: { label: 'Node 2' }, position: { x: 100, y: 100 } },
  { id: 'interaction-3', data: { label: 'Node 3' }, position: { x: 400, y: 100 } },
  { id: 'interaction-4', data: { label: 'Node 4' }, position: { x: 400, y: 200 } },
  { id: 'interaction-e1-2', source: 'interaction-1', target: 'interaction-2', animated: true },
