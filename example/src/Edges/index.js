...
const initialElements = [
  { id: 'edges-1', type: 'input', data: { label: 'Input 1' }, position: { x: 250, y: 0 } },
  ...
  { id: 'edges-8', type: 'output', data: { label: 'Output 8' }, position: { x: 525, y: 600 } },
  { id: 'edges-e1-2', source: 'edges-1', target: 'edges-2', label: 'bezier edge (default)', className: 'normal-edge' },
  { id: 'edges-e2-2a', source: 'edges-2', target: 'edges-2a', type: 'smoothstep', label: 'smoothstep edge' },
  { id: 'edges-e2-3', source: 'edges-2', target: 'edges-3', type: 'step', label: 'step edge' },
  { id: 'edges-e3-4', source: 'edges-3', target: 'edges-4', type: 'straight', label: 'straight edge' },
  {
    id: 'edges-e3-3a',
    source: 'edges-3',
    target: 'edges-3a',
